...
def expiry_is_current_or_next_month(expiry):
    ...
    return (expiry_date.year, expiry_date.month) in (current_month, next_month)
...
def build_contracts(kite):
    ...
    for item in instruments:
        ...
        if not expiry_is_current_or_next_month(expiry):
            continue
