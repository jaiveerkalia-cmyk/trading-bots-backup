...
DAY_CONFIGURATION = {
    ...
    # Tuesday (NIFTY)
    1: {'target_index': 'NIFTY', 'start': '09:20', 'exit': '15:15', 'entry_gap': 5, 'strike_gap': 2, 'lots': 3, 'live_mode': 1, 'percent_mode': 1, 'find_atm': True,
    ...
    # Thursday (SENSEX)
    3: {'target_index': 'SENSEX', 'start': '09:16', 'exit': '15:25', 'entry_gap': 10, 'strike_gap': 2, 'lots': 3, 'live_mode': 0, 'percent_mode': 1, 'find_atm': True,
