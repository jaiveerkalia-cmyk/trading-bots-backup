...
DAY_CONFIGURATION = {
    ...
    # Tuesday (NIFTY)
    1: {'target_index': 'NIFTY', 'start': '09:20', 'exit': '15:15', 'entry_gap': 5, 'strike_gap': 2, 'lots': 3, 'live_mode': 0, 'percent_mode': 1, 'find_atm': True,
        'total_premium_skip': False, 'buy_strikes_flag': True, 'total_profit_change': True, 'atr_mode_on': False, 'atr_ema_window': 20,
        'atr_stop_per_lot': 30, 'atr_entry_gap': 10, 'skip_till_hour': 8, 'target_profit_per_lot': TARGET_PROFIT_PER_LOT,
        'max_loss_per_lot': MAX_LOSS_PER_LOT, 'stop_percent': 30, 'vix_stop_mode_on': True, 'hedgeless_mode': True,
        'index_based_entry': True, 'atr_entry_multiplier': 3},
    ...
    # Thursday (SENSEX)
    3: {'target_index': 'SENSEX', 'start': '09:16', 'exit': '15:25', 'entry_gap': 10, 'strike_gap': 2, 'lots': 3, 'live_mode': 1, 'percent_mode': 1, 'find_atm': True,
    ...
    # Friday (NIFTY)
   4: {'target_index': 'NIFTY', 'start': '09:16', 'exit': '14:45', 'entry_gap': 5, 'strike_gap': 0, 'lots': 6, 'live_mode': 0, 'percent_mode': 0, 'find_atm': True,
       'total_premium_skip': False, 'buy_strikes_flag': False, 'total_profit_change': False, 'atr_mode_on': False, 'atr_ema_window': 20,
       'atr_stop_per_lot': 30, 'atr_entry_gap': 10, 'skip_till_hour': 8, 'target_profit_per_lot': TARGET_PROFIT_PER_LOT,
